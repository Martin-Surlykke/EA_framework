...
public class BitStringLeadingOnesProblem implements Problem, BitStringCompatible, HasFitness {
    ...
    private final Fitness fitnessFunction = new BitStringLeadingOnes();

    public BitStringLeadingOnesProblem(String name, int length, boolean[] defaultBitString) {
        this.name = name;
        this.length = length;
